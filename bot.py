...
7. Зберігай природний розмовний стиль
8. НЕ додавай нічого від себе
9. Починай одразу з тексту, без вступних коментарів

РОЗПОДІЛ РЕПЛІК МІЖ СПІКЕРАМИ — критично важливо:
- Уважно аналізуй контекст кожної фрази: хто ставить запитання, хто відповідає
- Ангеліна Завадецька та Максим Самойлюк — ведучі, вони ставлять запитання, уточнюють, підводять підсумки
- Гість — експерт, він розгорнуто відповідає на запитання
- Якщо автотранскрибатор не позначив спікера — визнач його з контексту
- Довгі експертні відповіді належать гостю; короткі уточнювальні фрази — ведучим
- Ніколи не приписуй одному спікеру підряд і запитання, і розгорнуту відповідь на нього

ФОРМАТ ГРОШОВИХ СУМ — обов'язково:
- Завжди скорочуй великі суми: 150 000 000 000 → $150 млрд, 5 000 000 → $5 млн
- Формат: символ валюти + число + скорочення (млрд / млн / тис.)
- Приклади: $9 млрд, €2,5 млрд, ₴500 млн, $14 млрд, 150 млрд доларів → $150 млрд
- Якщо валюта не вказана але зрозуміла з контексту — постав відповідний символ
